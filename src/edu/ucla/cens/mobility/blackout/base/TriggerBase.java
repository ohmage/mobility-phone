...
import edu.ucla.cens.mobility.blackout.MobilityBlackoutManager;
import edu.ucla.cens.mobility.blackout.notif.NotifDesc;
import edu.ucla.cens.mobility.blackout.notif.Notifier;
...
public abstract class TriggerBase {
	...
	public void notifyTrigger(Context context, int trigId) {
		...
		Log.d(TAG, db.getRunTimeDescription(trigId) + " is the run time description!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
