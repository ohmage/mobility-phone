...
import edu.ucla.cens.mobility.blackout.base.TriggerRunTimeDesc;
import edu.ucla.cens.mobility.blackout.base.BlackoutList;
import edu.ucla.cens.mobility.blackout.utils.TrigPrefManager;
...
//					   trig.getColumnIndexOrThrow(TriggerDB.KEY_NOTIF_DESCRIPT));
		...
		String actions = trig.getString(
						 trig.getColumnIndexOrThrow(TriggerDB.KEY_TRIG_ACTIVE_DESCRIPT));
...
//						  trig.getColumnIndexOrThrow(TriggerDB.KEY_TRIG_TYPE));
		...
		TriggerBase trigBase = new Blackout();// new TriggerTypeMap().getTrigger(/*trigType*/);
		if(trigBase != null) {
